...
namespace Wave.Essence.Interaction.Toolkit.Editor
{
	public class BuildUICanvas
	{
		...
		static void SetPlayerSettings(bool is32bits = false)
		{
			...
			PlayerSettings.productName = "UICanvas";
			PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.Android, "com.htc.upm.wave.uicanvas");
			if (!is32bits)
		...
		{
			return new string[] {
				"Assets/Wave/Essence/Interaction/Toolkit/Demo/UICanvas.unity",
			};
		}
		...
		//[MenuItem("Wave/Build UICanvas/32 bits", priority = 302)]
		public static void BuildApkX32()
		{
			if (EditorUserBuildSettings.activeBuildTarget != BuildTarget.Android)
				return;
			string path = Application.dataPath + "/../UICanvas_x32.apk";
		...
		//[MenuItem("Wave/Build UICanvas/64 bits", priority = 302)]
		public static void BuildApkX64()
		{
			if (EditorUserBuildSettings.activeBuildTarget != BuildTarget.Android)
				return;
			string path = Application.dataPath + "/../UICanvas_x64.apk";
